...
public class BackgroundZipShare extends AsyncTask
{
    ...
    public BackgroundZipShare(Activity activity, DataBaseHelper dataBaseHelper)
    {
    ...
    protected Object doInBackground(Object[] objects) {
        file = FileImportExport.exportAndShareZipSubject(activity, dataBaseHelper);
        return null;
    }
